...
prompt-based methods have been rarely introduced in graph domains yet. We only find very few works like [GPPT](https://dl.acm.org/doi/abs/10.1145/3534678.3539249)
, trying to
